...
const openai = new OpenAI({
    ...
    export const generate = async (startDate, fullName, amountOfDays, gptModel) => {
        ...
        .doctors-note {
            ...
            line-height: 1.5;
            margin: 20px auto;
            max-width: 612px;  /*adjusted to A4 width in points*/
            padding: 40px;
